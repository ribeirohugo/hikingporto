...
export function Home() {
  return (
    <main className="flex-1">
      ...
      <section className="bg-linear-to-br from-green-600 to-emerald-800 text-white py-20 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold px-7 py-3.5 rounded-full transition-colors shadow-sm"
          >
